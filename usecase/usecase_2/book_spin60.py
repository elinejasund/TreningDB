...
def book_group_lesson(member: str, activity: str, time: str):
    with sqlite3.connect("DB2.db") as con:
        ...
        WHERE group_lesson.time = ? AND lesson_types.activity_type_id = ?
        """, (time, activity_id))
...
book_group_lesson("johnny@stud.ntnu.no", "Spin60", "2025-03-17 18:30")
