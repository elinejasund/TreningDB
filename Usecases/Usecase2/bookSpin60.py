...
cursor.execute("SELECT COUNT(*) FROM group_lesson_participates WHERE group_lesson_id = ?", (lesson_id,))
...
# Book: insert
cursor.execute("INSERT INTO group_lesson_participates (member_id, group_lesson_id) VALUES (?, ?)", (member_id, lesson_id))
con.commit()
